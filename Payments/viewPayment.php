    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--white mdl-color--grey-100 mdl-color-text--grey-600" style="background-color: rgb(63, 81, 181); color: #ffffff;">
        ...
        <div class="mdl-layout__header-row" style="background-color: rgb(63, 81, 181); color: #ffffff;">
          ...
          <span class="mdl-layout-title">Payments Page</span>
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href="addPayment.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">add</i> Add Payment</a>
          <a class="mdl-navigation__link" href="viewPayment.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>Show All Payments</a>
          <div class="mdl-layout-spacer"></div>
<!--Add help here -->
